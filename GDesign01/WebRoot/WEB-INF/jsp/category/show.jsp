	...
	<%-- 	<span><s:a action="category_show?pageNo=%{pageNo-1}">上一页</s:a></span> --%>
		...
		<ul data-am-widget="pagination"
			...
			<li class="am-pagination-first "><s:a
					action="category_show?pageNo=1">第一页</s:a></li>

			<li class="am-pagination-prev "><s:a
					action="category_show?pageNo=%{pageNo-1}">上一页</s:a></li>

			<s:iterator begin="%{beginIndex}" end="%{endIndex}" var="num">
				<s:if test="#num==pageNo">
					<li class="am-active"><s:a
							action="category_show?pageNo=%{num}" class="am-active">${num }</s:a></li>
				</s:if>
				<s:else>
			...
			<li class="am-pagination-next "><s:a
					action="category_show?pageNo=%{pageNo+1}">下一页</s:a></li>

			<li class="am-pagination-last "><s:a
					action="category_show?pageNo=%{totalPage}">最末页</s:a></li>
		</ul>
